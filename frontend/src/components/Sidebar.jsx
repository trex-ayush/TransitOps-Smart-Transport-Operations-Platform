  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-stone bg-white/70 px-5 py-8 backdrop-blur-sm">
      <div className="mb-12 px-3">
        ...
        <p className="mt-1 text-[11px] uppercase tracking-widest text-sage">
          Fleet Operations
        </p>
      </div>
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 rounded-full px-4 py-2.5 text-sm transition-colors duration-300 ${
                isActive
                  ...
                  : "text-forest/70 hover:bg-clay/40 hover:text-forest"
              }`
            }
          >
      ...
      <p className="px-3 text-[11px] uppercase tracking-widest text-forest/40">
        TransitOps © 2026
      </p>
    </aside>
  );
